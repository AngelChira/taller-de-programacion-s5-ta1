#   Semana 05 Taller de Programación Tarea Academica 01
Este repositorio es sobre la tarea Academica 01 de la Semana 05 del curso de Taller de Programación
...
```
https://github.com/AngelChira/taller-de-programacion-s5-ta1
```

2. Abrir el Apache NetBeans y seleccionar "Open Project" en la parte superior izquierda
3. Navega hasta la ubicación del proyecto "TareaAcademica01" y haz 2 click en el proyecto.
